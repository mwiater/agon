...
func writePromptSuite(t *testing.T, dir string) {
	t.Helper()
	if err := os.MkdirAll(filepath.Join(dir, "internal", "accuracy"), 0o755); err != nil {
  ...
  "tests": [
	...
	if err := os.WriteFile(filepath.Join(dir, "internal", "accuracy", "accuracy_prompts.json"), []byte(suite), 0o644); err != nil {
